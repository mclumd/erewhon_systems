...
/**
 * GeneralizedModusPonens does a depth first search on the left hand side of
 * a simple IfFormula and returns the answer in a single step. This means that
 * should a callFormula return an infinite amount of bindings, this inference
 * rule will degenerate into an infinite loop.
 * @author percy
 *
 */
