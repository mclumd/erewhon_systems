...
public abstract class FormulaNode implements Cloneable{
	...
	//public static final Operator DISTRUST = new Operator("distrust", "*");
	public static final Operator IF = new Operator("if", "=>");
	public static final Operator IFNEW = new Operator("ifnew", "->");
	//public static final Operator AND = new Operator("and", "&");
	//public static final Operator OR = new Operator("or", "|");
	//public static final Operator GOAL = new Operator("goal", "?");
	//public static final Operator NOT = new Operator("not", "~");
	public static final Operator PREDICATE = new Operator("predicate", "pred");
	public static final Operator VARIABLE = new Operator("variable", "var");
	public static final Operator CONSTANT = new Operator("constant", "const");
	*/
	
	public abstract FormulaNode applySubstitution(UnifiedMap um);
	
	public abstract boolean unify(FormulaNode fn, UnifiedMap um);
	public abstract boolean unify(Variable v, UnifiedMap um);
	public abstract boolean unify(Constant c, UnifiedMap um);
	public abstract boolean unify(ComplexNode cn, UnifiedMap um);
