...
int main(int argc, char *argv[]) {
   ...
   if (argc>3) 
    ...
    for (current_problem=0; current_problem<num_problem; current_problem++) {
      ...
      sprintf(filename, "./problems/p%d_%d.nshp", num_block, current_problem+1);
