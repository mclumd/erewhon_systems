...
(with-open-file (s *hgn-output*
  ...
  (dolist (my-problem shop2::*all-problems*)
    ...
    (let* ((start-internal-time (get-internal-run-time))
           (state-obj (apply 'shop2.common:make-initial-state *domain* *state-encoding* (shop2::problem->state *domain* my-problem)))
