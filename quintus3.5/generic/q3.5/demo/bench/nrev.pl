...
/* @(#)nrev.pl	28.2 05/30/90 */

/* NREV.PL : The classic Prolog benchmark
...
calculate_lips(_Count,Time,'Infinite','msecs') :- /* Time can be 0 for small */
	Time =:= 0, !.				  /* values of Count!        */
