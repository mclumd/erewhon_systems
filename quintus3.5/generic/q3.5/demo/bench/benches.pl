...
/* @(#)benches.pl	28.1 05/30/90 */

/* BENCHES.PL

	AI Expert Prolog benchmark set.

	These benchmarks were written by Fernando Pereira of SRI to test
	various different aspects of a Prolog implementation.  The benchmarks
	concentrate on "basic exection" performance and do not perform any
	input/output or other operating system interface functions.  They were
	written by someone with a deep understanding of Prolog implementation
	with the goal of testing distinct implementation areas.

	These benchmarks were used for a comparison of different PC and MAC
	Prologs in the June 1987 issue of AI Expert magazine (published by
	Miller Freeman, 500 Howard st, San Francisco, CA 94105, 415-397-1881).
	AI Expert has also made versions available on various bulletin boards.

*/

/* ----------------------------------------------------------------------
	TOP LEVEL DRIVER FOR GATHERING STATISTICS

	This top level written by Quintus for Quintus Prolog.
   ---------------------------------------------------------------------- */

:- no_style_check(discontiguous).

test_benches :-
	format('Benchmark Set from AI Expert magazine~n~n',[]),
	bench_mark(Name,Average),
	  format('  ~w~t~24+~t~3f~10+~n',[Name,Average]),
	fail.
test_benches.
...
bench_mark(Name,Average) :-
        ...
        TestTime is T1-T0,
        OverHead is T2-T1,
        Average  is (TestTime-OverHead) / Iterations.
