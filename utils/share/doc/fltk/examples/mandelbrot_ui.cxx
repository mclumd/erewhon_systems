...
void Drawing_Window::make_window() {
  { Fl_Window* o = window = new Fl_Window(450, 520);
    ...
    { d = new Drawing_Area(20, 80, 410, 430);
      d->box(FL_DOWN_BOX);
      d->color((Fl_Color)FL_FOREGROUND_COLOR);
      d->selection_color((Fl_Color)FL_DARK1);
      d->labeltype(FL_NORMAL_LABEL);
      d->labelfont(0);
      d->labelsize(14);
      d->labelcolor((Fl_Color)FL_FOREGROUND_COLOR);
    ...
    { Fl_Input* o = x_input = new Fl_Input(30, 15, 125, 30, "x:");
      ...
      x_input->color((Fl_Color)FL_INACTIVE_COLOR);
      x_input->selection_color((Fl_Color)FL_BACKGROUND2_COLOR);
    ...
    { Fl_Input* o = y_input = new Fl_Input(175, 15, 125, 30, "y:");
      ...
      y_input->color((Fl_Color)FL_INACTIVE_COLOR);
      y_input->selection_color((Fl_Color)FL_BACKGROUND2_COLOR);
    ...
    { Fl_Input* o = w_input = new Fl_Input(325, 15, 105, 30, "w:");
      ...
      w_input->color((Fl_Color)FL_INACTIVE_COLOR);
      w_input->selection_color((Fl_Color)FL_BACKGROUND2_COLOR);
