    ...
    { Fl_Group* o = new Fl_Group(5, 3, 374, 399);
      { VChange = new Fl_Group(5, 100, 37, 192);
        ...
        { ypan = new Fl_Slider(25, 100, 17, 186, "V Pan");
          ypan->type(4);
          ypan->selection_color((Fl_Color)FL_DARK_BLUE);
      ...
      { HChange = new Fl_Group(120, 362, 190, 40);
        { xpan = new Fl_Slider(122, 364, 186, 17, "H Pan");
          xpan->type(5);
          xpan->selection_color((Fl_Color)FL_DARK_BLUE);
      ...
      { MainView = new Fl_Group(46, 27, 333, 333);
        ...
        { cube = new CubeView(48, 29, 329, 329, "This is the cube_view");
          cube->box(FL_NO_BOX);
          cube->color((Fl_Color)FL_BACKGROUND_COLOR);
          cube->selection_color((Fl_Color)FL_BACKGROUND_COLOR);
          cube->labeltype(FL_NORMAL_LABEL);
          cube->labelfont(0);
          cube->labelsize(14);
          cube->labelcolor((Fl_Color)FL_FOREGROUND_COLOR);
      ...
      { zoom = new Fl_Value_Slider(106, 3, 227, 19, "Zoom");
        zoom->type(5);
        zoom->selection_color((Fl_Color)FL_DARK_BLUE);
        zoom->labelfont(1);
        zoom->labelsize(12);
        zoom->minimum(1);
        zoom->maximum(50);
