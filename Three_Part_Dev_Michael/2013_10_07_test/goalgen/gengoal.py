...
from gengoal_tree import GoalGenTree
...
class GoalGen:
    ...
    def give_goal_tree(self, blockset):
        return GoalGenTree().give_goal(blockset)
    ...
    def give_goal(self, blockset):
        ...
        goal_tree = self.give_goal_tree(blockset)
        ...
        print "goal tree:"
        print "    goaltype: ", goal_tree.goaltype
        print "    goalargs: ", goal_tree.goalargs
        for arg in goal_tree.goalargs:
            print "        ", arg.id
