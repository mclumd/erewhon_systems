(setf (current-problem)
  (create-problem
    ...
    (objects 
        ...
        (airplaneA airplaneB airplaneC airplaneD airplaneE airplaneF airplaneG AIRPLANE)
    ...
    (state
      (and
          ...
          (at-airplane airplaneB airport_cityA)
          (at-airplane airplaneD airport_cityD)
          (at-airplane airplaneC airport_cityG)
          (at-airplane airplaneA airport_cityI)
          (at-airplane airplaneG airport_cityE)
          (at-airplane airplaneE airport_cityI)
          (at-airplane airplaneF airport_cityE)
          (inside-truck objectA truck_cityI)
))
    (goal
      (and
          (at-obj objectA airport_cityF)
))))