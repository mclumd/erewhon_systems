  ...
  (create-problem
    ...
    (state
      (and
          ...
          (at-airplane airplaneB airport_cityI)
          (at-obj objectD airport_cityG)
          (inside-truck objectB truck_cityJ)
          (at-obj objectA po_cityJ)
          (at-obj objectC po_cityI)
          (inside-truck objectF truck_cityJ)
          (inside-truck objectE truck_cityE)
          (inside-airplane objectG airplaneB)
))
    (goal
      (and
          (at-obj objectE airport_cityB)
          (at-obj objectB po_cityH)
))))