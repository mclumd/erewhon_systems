  ...
  (create-problem
    ...
    (state
      (and
          ...
          (at-airplane airplaneC airport_cityA)
          (at-airplane airplaneE airport_cityD)
          (at-airplane airplaneD airport_cityA)
          (at-airplane airplaneA airport_cityF)
          (at-airplane airplaneB airport_cityE)
          (at-airplane airplaneF airport_cityI)
          (at-obj objectH airport_cityC)
          (at-obj objectG po_cityE)
          (inside-airplane objectC airplaneE)
          (at-obj objectA po_cityG)
          (at-obj objectD po_cityF)
          (inside-truck objectF truck_cityC)
          (at-obj objectB po_cityF)
          (inside-truck objectI truck_cityD)
          (at-obj objectE airport_cityI)
))
    (goal
      (and
          (at-obj objectA po_cityJ)
))))