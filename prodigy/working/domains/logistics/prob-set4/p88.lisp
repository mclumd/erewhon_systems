  ...
  (create-problem
    ...
    (state
      (and
          ...
          (at-airplane planeG airport_cA)
          (at-airplane planeH airport_cD)
          (at-airplane planeF airport_cB)
          (at-airplane planeB airport_cF)
          (at-airplane planeD airport_cF)
          (at-airplane planeE airport_cF)
          (inside-truck objE t_cE)
          (inside-truck objB t_cD)
          (at-obj objD airport_cA)
          (inside-airplane objA planeF)
