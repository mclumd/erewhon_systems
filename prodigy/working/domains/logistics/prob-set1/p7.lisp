  ...
  (create-problem
    ...
    (state
      (and
          ...
          (inside-truck objG t_cJ)
          (at-obj objC airport_cG)
          (inside-truck objF t_cG)
          (inside-airplane objH planeA)
          (at-obj objD airport_cE)
          (inside-truck objB t_cB)
          (at-obj objJ po_cE)
          (at-obj objE po_cI)
          (at-obj objI po_cD)
          (inside-truck objA t_cI)
))
    (goal
      (and
          (at-obj objB po_cF)
          (at-obj objC airport_cI)
          (at-obj objE po_cF)
          (at-obj objF airport_cB)
))))