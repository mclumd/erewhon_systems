(setf (current-problem)
  (create-problem
    ...
    (objects 
        ...
        (objA objB objC objD objE objF objG objH objI OBJECT)
    ...
    (state
      (and
          ...
          (at-airplane planeF airport_cH)
          (at-airplane planeD airport_cA)
          (at-airplane planeB airport_cF)
          (at-airplane planeC airport_cA)
          (at-airplane planeE airport_cD)
          (at-obj objB airport_cF)
          (at-obj objE po_cG)
          (at-obj objF po_cG)
          (inside-truck objA t_cH)
          (inside-airplane objG planeB)
          (at-obj objI po_cH)
          (inside-airplane objC planeF)
          (inside-truck objD t_cC)
          (inside-airplane objH planeC)
))
    (goal
      (and
          (at-obj objE airport_cE)
          (at-obj objA airport_cB)
          (at-obj objG airport_cB)
          (at-obj objH airport_cA)
))))