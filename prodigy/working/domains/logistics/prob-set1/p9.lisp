  ...
  (create-problem
    ...
    (state
      (and
          ...
          (at-obj objE airport_cJ)
          (at-obj objG airport_cG)
          (inside-airplane objA planeC)
          (at-obj objI po_cD)
          (inside-truck objJ t_cD)
          (at-obj objC po_cI)
          (at-obj objB airport_cH)
          (at-obj objD airport_cG)
          (inside-truck objF t_cH)
          (inside-truck objH t_cI)
))
    (goal
      (and
          (at-obj objB po_cH)
