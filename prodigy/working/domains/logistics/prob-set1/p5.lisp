  ...
  (create-problem
    ...
    (state
      (and
          ...
          (part-of t_cJ cJ)
          (at-truck t_cJ po_cJ)
          (at-airplane planeC airport_cG)
          (at-airplane planeE airport_cC)
          (at-airplane planeA airport_cI)
          (at-airplane planeD airport_cH)
          (at-airplane planeB airport_cC)
          (inside-airplane objB planeE)
          (inside-truck objD t_cC)
          (inside-truck objC t_cG)
          (at-obj objA po_cA)
    ...
    (goal
      (and
          (at-obj objD po_cF)
          (at-obj objA po_cC)
          (at-obj objC airport_cJ)
          (at-obj objB airport_cI)
))))