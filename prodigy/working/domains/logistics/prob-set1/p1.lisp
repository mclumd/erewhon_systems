  ...
  (create-problem
    ...
    (state
      (and
          ...
          (at-airplane planeC airport_cH)
          (at-airplane planeE airport_cE)
          (at-airplane planeB airport_cI)
          (at-airplane planeA airport_cB)
          (at-airplane planeD airport_cJ)
          (inside-airplane objG planeB)
          (at-obj objB airport_cA)
          (inside-truck objE t_cJ)
          (inside-truck objC t_cA)
          (at-obj objA po_cB)
