(setf (current-problem)
  (create-problem
    ...
    (objects 
        ...
        (objectA objectB objectC objectD objectE objectF OBJECT)
        ...
        (airplaneA airplaneB airplaneC airplaneD airplaneE AIRPLANE)
    ...
    (state
      (and
          ...
          (at-airplane airplaneA airport_cityE)
          (at-airplane airplaneD airport_cityB)
          (at-airplane airplaneE airport_cityD)
          (at-airplane airplaneB airport_cityD)
          (at-airplane airplaneC airport_cityF)
          (inside-truck objectB truck_cityB)
          (inside-truck objectE truck_cityB)
          (at-obj objectA airport_cityC)
          (inside-airplane objectD airplaneC)
          (at-obj objectC airport_cityB)
          (inside-truck objectF truck_cityI)
))
    (goal
      (and
          (at-obj objectC airport_cityG)
))))