(setf (current-problem)
  (create-problem
    ...
    (objects 
        ...
        (airplaneA airplaneB airplaneC airplaneD airplaneE airplaneF AIRPLANE)
    ...
    (state
      (and
          ...
          (at-truck truck_cityH airport_cityH)
          ...
          (at-airplane airplaneB airport_cityC)
          (at-airplane airplaneA airport_cityI)
          (at-airplane airplaneF airport_cityA)
          (at-airplane airplaneD airport_cityE)
          (at-airplane airplaneE airport_cityD)
          (at-airplane airplaneC airport_cityE)
          (inside-truck objectD truck_cityD)
          (inside-airplane objectE airplaneD)
          (at-obj objectH airport_cityG)
          (inside-truck objectF truck_cityJ)
          (at-obj objectB po_cityJ)
          (at-obj objectC airport_cityH)
          (inside-truck objectA truck_cityB)
          (at-obj objectI po_cityA)
          (at-obj objectG po_cityH)
))
    (goal
      (and
          (at-obj objectC airport_cityF)
          (at-obj objectA po_cityF)
          (at-obj objectD airport_cityF)
          (at-obj objectI airport_cityA)
))))