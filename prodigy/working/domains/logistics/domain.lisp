...
Anomalous LOGISTICS domain.

This file is the normal domain.lisp file with one or more operators
comments out along with the control rules that select or reject the
operators. The anomaly (i.e., missing OP) in this file is
UNLOAD-TRUCK.
