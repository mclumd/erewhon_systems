  ...
  (create-problem
    ...
    (state
      (and
          ...
          (at-airplane planeC airport_cE)
          (at-airplane planeE airport_cE)
          (at-airplane planeF airport_cD)
          (at-obj objG airport_cD)
          (inside-truck objC t_cE)
          (inside-airplane objD planeA)
          (at-obj objA po_cE)
          (inside-airplane objH planeH)
          (inside-truck objB t_cA)
          (at-obj objF airport_cD)
          (at-obj objE airport_cF)
))
    (goal
      (and
          (at-obj objG po_cA)
          (at-obj objF airport_cF)
          (at-obj objH po_cA)
          (at-obj objB po_cA)
))))