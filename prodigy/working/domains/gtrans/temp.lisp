...
(ptype-of defensive-state :top-type)
(pinstance-of impassable defensive-state)
(pinstance-of restricts-movement defensive-state)
...
(pinstance-of air-interdiction MISSION-NAME)
...
;					  <external-security-force2>)
   ...
   (and (loc-at <airport> <loc>) ;Not state 4 subgoal, used to bind <country>
	(is-deployed  <internal-security-force> <airport>)
;	(is-deployed  <external-security-force1> <loc>)
	(is-deployed  <external-security-force2> <airport>))
   )
  (effects
   ()
