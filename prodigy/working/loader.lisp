...
(defvar *directory-separator*
  #+APPLE #\:
  #+(OR UNIX MACH MSWINDOWS (AND DOS CLISP))  #\/
...
(defun set-binary-path (&optional 
  ...
  (concatenate 'string 
	       ...
	       #+(and ALLEGRO SPARC ALLEGRO-V6.0) ".sparc-allegro-6.0/"
	       #+(and ALLEGRO SPARC ALLEGRO-V5.0.1) ".sparc-allegro-5.0.1/"
	       #+(and ALLEGRO MSWINDOWS ALLEGRO-V5.0.1) ".mswin-allegro-5.0.1/"
	       #+(and ALLEGRO MSWINDOWS ALLEGRO-V6.0) ".mswin-allegro-6.0/"
	       #+(and ALLEGRO MSWINDOWS ALLEGRO-V6.2) ".mswin-allegro-6.2/"
	       #+(and ALLEGRO MSWINDOWS ALLEGRO-V8.2) ".mswin-allegro-8.2/"
	       #+(and ALLEGRO LINUX ALLEGRO-V8.2) ".linux-allegro-8.2/"
...
(defun p-load (module-name 
		...
		*system-directory*))
  (load (concatenate
; (excl:load-compiled (concatenate 
	 'string
	 system-path 
	 module-name 
	 file 
