...
;;===== Peter's SABA-reactive code - Manuela's SABA code 
;; so I know -- Manuela -- original is in prodigy4.0/saba
  ...
  (cond
   ...
   (t
    (let* ((p-a-d-all-ops (preconds-adds-dels-list applicable-ops))
	   (most-free (find-most-free p-a-d-all-ops 0)))
      ;;(1- (length applicable-ops))))) ;mmv 02/19/97
      (if most-free
...
(defun find-most-free (filled-list-applicable-ops pos)
  (cond
   ;;((< pos 0) nil) ;mmv 02/19/97
   ((= pos (length filled-list-applicable-ops)) nil)
   ...
   (t
    ;;(find-most-free filled-list-applicable-ops (1- pos))))) ;mmv 02/19/97
