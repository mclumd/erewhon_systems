...
;;; 
;;; NOTE that the *domain-file* variable is defined in registrar.lisp and so
;;; this file must be loaded after loading registrar.lisp
...
;;; the *domain-file* variable is defined in registrar.lisp. [cox 27mar01]
;;; 
