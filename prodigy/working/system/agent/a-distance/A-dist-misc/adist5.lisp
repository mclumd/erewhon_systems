...
(setf *dif1* (butlast (get-differences (list-concat *data1*))))
(setf *dif2* (butlast (get-differences (list-concat *data2*))))
...
(setq *wps* (create-window-pairs 8 *dif1* .05 .5 100))
(setq *alphas* (compute-alphas 8 *wps* *dif1* .1 10))
...
(find-change-v 8 *wps* *alldata* *alphas*)
