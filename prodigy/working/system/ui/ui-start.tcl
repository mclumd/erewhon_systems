...
#
# 13jul00 Changed port number so the Tcl/Tk GUI will not interfere with the
#         JAVA UIP port assignment.
...
#
set ui_home "/prodigy/working/system/ui"

# The corresponding variable *world-path* is defined in file loader.lisp.
#
set world_path "/prodigy/working/domains/"
...
#    mcox    {set user_path "/prodigy/working/domains/"}
switch $uid {
    mcox    {set user_path "/nfs/valhalla/users25/csgrad/bkerkez/ai/prodigy/working/domains/"}
...
set analogy_setup "/prodigy/working/system/analogy/loader.lisp"
