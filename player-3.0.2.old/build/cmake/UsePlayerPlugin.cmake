...
IF (NOT PKG_CONFIG_FOUND)
    ...
    LIST (APPEND PLUGIN_PLAYERC_INCLUDE_DIRS "/fs/erewhon/group/systems/utils/include/player-3.0")
    SET (PLUGIN_PLAYERC_LINK_LIBS m;z)
    LIST (APPEND PLUGIN_PLAYERC_LINK_LIBS "playerc")
    SET (PLUGIN_PLAYERC_LIBRARY_DIRS )
    LIST (APPEND PLUGIN_PLAYERC_LIBRARY_DIRS "/fs/erewhon/group/systems/utils/lib")
...
IF (NOT PKG_CONFIG_FOUND)
    ...
    LIST (APPEND PLAYERCORE_INCLUDE_DIRS "/fs/erewhon/group/systems/utils/include/player-3.0")
    SET (PLAYERCORE_LINK_LIBS pthread;ltdl;dl)
    LIST (APPEND PLAYERCORE_LINK_LIBS "playercore")
    SET (PLAYERCORE_LIBRARY_DIRS )
    LIST (APPEND PLAYERCORE_LIBRARY_DIRS "/fs/erewhon/group/systems/utils/lib")
