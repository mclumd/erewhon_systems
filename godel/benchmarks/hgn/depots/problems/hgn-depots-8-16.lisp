...
(defproblem DEPOTPROB160 depots-domain-hgn
 ...
 ((PALLET PALLET0) (SURFACE PALLET0) (AT PALLET0 DEPOT0) (CLEAR CRATE7)
  ...
  (SURFACE CRATE6) (AT CRATE6 DISTRIBUTOR0) (ON CRATE6 CRATE2)
  (CRATE CRATE7) (SURFACE CRATE7) (AT CRATE7 DEPOT0) (ON CRATE7 CRATE5)
  (PLACE DEPOT0) (PLACE DISTRIBUTOR0)) 
 
 ;; goal 
((ON CRATE0 CRATE7) (ON CRATE1 CRATE5) (ON CRATE2 CRATE1)
 (ON CRATE3 CRATE4) (ON CRATE4 PALLET1) (ON CRATE5 PALLET0)
 (ON CRATE6 CRATE0) (ON CRATE7 CRATE2)))