...
(defproblem DEPOTPROB100 depots-domain-hgn
 ...
 ((PALLET PALLET0) (SURFACE PALLET0) (AT PALLET0 DEPOT0) (CLEAR CRATE5)
  ...
  (SURFACE CRATE6) (AT CRATE6 DISTRIBUTOR0) (ON CRATE6 CRATE3)
  (CRATE CRATE7) (SURFACE CRATE7) (AT CRATE7 DISTRIBUTOR0)
  (ON CRATE7 CRATE6) (PLACE DEPOT0) (PLACE DISTRIBUTOR0)) 
 
 ;; goal 
((ON CRATE0 CRATE5) (ON CRATE1 CRATE4) (ON CRATE2 CRATE0)
 (ON CRATE3 PALLET1) (ON CRATE4 CRATE3) (ON CRATE5 CRATE7)
 (ON CRATE6 PALLET0) (ON CRATE7 CRATE6)))