...
(defproblem DEPOTPROB130 depots-domain-hgn
 ...
 ((PALLET PALLET0) (SURFACE PALLET0) (AT PALLET0 DEPOT0) (CLEAR CRATE5)
  ...
  (CRATE CRATE4) (SURFACE CRATE4) (AT CRATE4 DEPOT0) (ON CRATE4 CRATE1)
 ...
 ;; goal 
((ON CRATE0 PALLET1) (ON CRATE1 CRATE4) (ON CRATE2 CRATE5)
 (ON CRATE3 CRATE1) (ON CRATE4 CRATE2) (ON CRATE5 PALLET0)
 (ON CRATE6 CRATE0) (ON CRATE7 CRATE6)))