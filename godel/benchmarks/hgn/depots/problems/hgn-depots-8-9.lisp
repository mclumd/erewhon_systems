...
(defproblem DEPOTPROB90 depots-domain-hgn
 ...
 ((PALLET PALLET0) (SURFACE PALLET0) (AT PALLET0 DEPOT0) (CLEAR CRATE7)
  ...
  (CLEAR CRATE5) (TRUCK TRUCK0) (AT TRUCK0 DISTRIBUTOR0) (HOIST HOIST0)
  ...
  (SURFACE CRATE6) (AT CRATE6 DEPOT0) (ON CRATE6 CRATE1) (CRATE CRATE7)
  (SURFACE CRATE7) (AT CRATE7 DEPOT0) (ON CRATE7 CRATE6) (PLACE DEPOT0)
  (PLACE DISTRIBUTOR0)) 
 
 ;; goal 
((ON CRATE1 PALLET0) (ON CRATE2 CRATE1) (ON CRATE4 CRATE7)
 (ON CRATE5 CRATE4) (ON CRATE6 CRATE5) (ON CRATE7 PALLET1)))