...
(defproblem DEPOTPROB250 depots-domain-hgn
 ...
 ((PALLET PALLET0) (SURFACE PALLET0) (AT PALLET0 DEPOT0) (CLEAR CRATE6)
  ...
  (AT CRATE7 DISTRIBUTOR0) (ON CRATE7 CRATE4) (PLACE DEPOT0)
  (PLACE DISTRIBUTOR0)) 
 
 ;; goal 
((ON CRATE0 CRATE6) (ON CRATE1 CRATE0) (ON CRATE2 PALLET1)
 (ON CRATE3 CRATE1) (ON CRATE5 CRATE3) (ON CRATE6 PALLET0)
 (ON CRATE7 CRATE2)))