#ifndef LANDMARKS_LANDMARK_FACTORY_GDP_RPG_SASP_H
#define LANDMARKS_LANDMARK_FACTORY_GDP_RPG_SASP_H
...
class LandmarkFactoryGDPRpgSasp : public LandmarkFactoryGDP {
...
public:
    LandmarkFactoryGDPRpgSasp(const Options &opts);
    virtual ~LandmarkFactoryGDPRpgSasp() {}
};
