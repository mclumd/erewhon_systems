#ifndef LANDMARKS_LANDMARK_FACTORY_GDP_H
#define LANDMARKS_LANDMARK_FACTORY_GDP_H
...
class LandmarkFactoryGDP {
public:
    LandmarkFactoryGDP(const Options &opts);
    virtual ~LandmarkFactoryGDP() {}
    ...
    LandmarkGraphGDP *compute_lm_graph();
protected:
    LandmarkGraphGDP *lm_graph;
