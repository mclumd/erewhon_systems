...
silent only
cd ~/research/code/fast-downward/src/translate/pddl
...
badd +8 actions.py
badd +9 methods.py
badd +125 conditions.py
badd +1 pddl_file.py
badd +1 pddl_types.py
badd +1 tasks.py
badd +1 parser.py
badd +0 effects.py
badd +0 __init__.py
...
exe 'vert 1resize ' . ((&columns * 100 + 65) / 131)
exe 'vert 2resize ' . ((&columns * 30 + 65) / 131)
argglobal
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 16 - ((13 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
16
...
178
normal zo
let s:l = 195 - ((27 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
195
...
92
normal zo
let s:l = 99 - ((32 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
99
normal! 06l
tabedit conditions.py
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
317
normal zo
let s:l = 320 - ((56 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
320
...
29
normal zo
let s:l = 59 - ((20 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
59
...
15
normal zo
let s:l = 30 - ((21 * winheight(0) + 11) / 23)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
30
normal! 0
tabedit pddl_types.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
