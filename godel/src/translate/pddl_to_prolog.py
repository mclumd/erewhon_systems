...
def translate_facts(prog, task):
    ...
    ### the next 3 lines are important for controlled grounding of methods
    for g in task.goal.parts:
        goal_pred = pddl.Atom(g.predicate + "-is-GOAL", g.args)
        prog.add_fact(goal_pred)
...
def translate(task):
    ...
    with timers.timing("Generating Datalog program"):
        ...
        # print ("\n after translating facts, the prolog program looks like this:")
        # prog.dump()
