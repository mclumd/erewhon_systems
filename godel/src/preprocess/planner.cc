...
int main(int argc, const char **) {
    ...
    cout << "reading preprocessed problem description ... " << endl;
    read_preprocessed_problem_description
        (cin, metric, internal_variables, variables, mutexes, initial_state, goals, operators, axioms, methods);
    /* dump_preprocessed_problem_description
        (variables, initial_state, goals, operators, axioms, methods);
    */

    /*
    cout << "size of methods is " << methods.size();
    ...
    */
    ...
    cout << "before stripping methods, size was " << methods.size() << endl;
    strip_methods(methods);
    cout << "after stripping methods, size was " << methods.size() << endl;
    strip_axioms(axioms);
    ...
    SuccessorGenerator successor_generator(ordering, operators, methods);
    ...
    generate_cpp_input(solveable_in_poly_time, ordering, metric,
                       ...
                       operators, axioms, methods, 
                       successor_generator, transition_graphs, 
                       causal_graph);
    cout << "done" << endl << endl;
}
