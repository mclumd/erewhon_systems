...
class Restaurants
{
  // socket related 
    ...
    {
	try {
	    System.out.println("Before buff in read menu");
	    BufferedReader read1 = new BufferedReader(new FileReader("menu.txt"));
	    ...
	    BufferedReader read2 = new BufferedReader(new FileReader("menu.txt"));
	    String line2 = "";
	    int index = 0;
	    while((line2 = read2.readLine()) != null)
		{
		    ...
		    index++;
               ...
               System.out.println("Problem reading the menus"); }
	catch(Exception e) { 
               System.out.println("Problem reading the menus"); }
    }
    ...
    {
	try {
	    System.out.println(" in Process Command " + command );
	    ...
	    System.out.println("Hello"+tokens[0]);
